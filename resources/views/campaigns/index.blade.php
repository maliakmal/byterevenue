          ...
          <table class="w-full mt-5">
            ...
            <tbody>
              @forelse ($campaigns as $campaign)
                <tr>
                  <td class="border border-gray-200 px-4 py-2">{{ $campaign->title }}</td>
