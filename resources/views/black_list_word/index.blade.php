      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
            ...
            <ol role="list" class="flex items-center space-x-4">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">BlackListWord</a>
                </div>
              </li>
            </ol>
          </nav>
          <h1 class="mt-2 text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">BlackListWord</h1>
        ...
        <div class="mt-5 flex xl:mt-0 xl:ml-4">
          ...
          <span class="ml-3 hidden sm:block">
            <a href="{{ route('black-list-words.create') }}" class="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-50">
<svg  class="-ml-1 mr-2 h-5 w-5 text-gray-400"xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" >
  <path fill-rule="evenodd" d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16Zm.75-11.25a.75.75 0 0 0-1.5 0v2.5h-2.5a.75.75 0 0 0 0 1.5h2.5v2.5a.75.75 0 0 0 1.5 0v-2.5h2.5a.75.75 0 0 0 0-1.5h-2.5v-2.5Z" clip-rule="evenodd" />
</svg> New Black List Word
</a>
          </span>
...
<table  class="mt-5 table-auto w-full">
      ...
      <tr>
                ...
                <td style="text-align: center"  class="border-b border-gray-200 px-4 py-2">{{ $item->word }}</td>
        ...
        <div class="flex w-0 flex-1">
          ...
          <div class="flex w-0 flex-1">
            <a href="{{ route('black-list-words.edit', $item->id) }}" class="relative -mr-px inline-flex w-0 flex-1 items-center justify-center gap-x-3  py-4 text-sm font-semibold text-gray-900">
          ...
          <div class="flex w-0 flex-1">
            <form action="{{ route('black-list-words.destroy', $item->id) }}" method="post" class="relative -ml-px inline-flex w-0 flex-1 items-center justify-center">
              @csrf
              @method('DELETE')
...
<div class="flex w-full items-center  space-x-6 p-6">
  <div class="flex-1 truncate">
    <div class="flex items-center space-x-3">
      <h3 class="truncate text-sm font-medium text-gray-900">No Black List Word found</h3>
