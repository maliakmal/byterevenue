      ...
      <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
        ...
        <table  class="mt-5 ">
          <thead >
            ...
            <a href="{{ route('contacts.edit', $contact->id) }}" class="relative   flex-1 items-center justify-center gap-x-3  py-4 text-sm font-semibold text-gray-900">
          ...
          <div class="flex w-0 flex-1">
            <form action="{{ route('contacts.destroy', $contact->id) }}" method="post" class="relative -ml-px inline-flex flex-1 items-center justify-center">
              @csrf
              @method('DELETE')
