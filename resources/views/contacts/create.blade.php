            ...
            <ol role="list" class="flex items-center space-x-4">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="/contacts" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Add Contacts</a>
                </div>
              </li>
            </ol>
          </nav>
          <h1 class="mt-2 text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Add Contacts</h1>
