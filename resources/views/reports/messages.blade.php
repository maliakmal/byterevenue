...
<header class="bg-gray-50 py-8">
  ...
  <form method="get" id="filter-form">
      ...
      <div class="h-12">
          <button type="button" onclick="download_csv.value=0;document.getElementById('filter-form').submit()"  class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
              Filter
          </button>
          <button type="button" onclick="download_csv.value=1;document.getElementById('filter-form').submit()" class="text-green-700 hover:text-white border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-green-500 dark:text-green-500 dark:hover:text-white dark:hover:bg-green-600 dark:focus:ring-green-800">
              Export CSV
          </button>
      </div>
