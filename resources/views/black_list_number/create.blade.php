        ...
        <form action="{{ route('black-list-numbers.store') }}" method="post">
            ...
            <div class="mb-4">
              <label for="key" class="block text-gray-700 text-sm font-bold mb-2">Phone Number</label>
                <textarea type="text" class="shadow appearance-none border rounded w-full py-9 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" style="height: 100vh" id="phone_number" name="phone_number"></textarea>
                <small style="color: darkred">Please define numbers in separated lines</small>
            </div>
