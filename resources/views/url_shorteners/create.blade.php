  ...
  <header class="bg-gray-50 py-8">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
        <div class="min-w-0 flex-1">
            ...
            <ol role="list" class="flex items-center space-x-4">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="/url_shorteners" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Short Domains</a>
                </div>
              </li>
              <li>
                <div class="flex items-center">
          ...
          <h1 class="mt-2 text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Create Short Domains</h1>
