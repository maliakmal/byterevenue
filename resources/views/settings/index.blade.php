      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 xl:flex xl:items-center xl:justify-between">
            ...
            <ol role="list" class="flex items-center space-x-4">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Settings</a>
                </div>
              </li>
            </ol>
          </nav>
          <h1 class="mt-2 text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Settings</h1>
        ...
        <div class="mt-5 flex xl:mt-0 xl:ml-4">
          ...
          <span class="ml-3 hidden sm:block">
            <a href="{{ route('settings.create') }}" class="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-50">
...
<table  class="mt-5 table-auto w-full">
      ...
      <tr>
        ...
        <div class="flex w-0 flex-1">
          ...
          <div class="flex w-0 flex-1">
            <form action="{{ route('settings.destroy', $item->id) }}" method="post" class="relative -ml-px inline-flex w-0 flex-1 items-center justify-center">
              @csrf
              @method('DELETE')
