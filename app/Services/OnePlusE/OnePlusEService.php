...
class OnePlusEService
{
    ...
    public function uploadCampaign($file)
    {
        $request = new \App\Services\OnePlusE\Requests\External\UploadCampaignRequest($file);
        $caller = new OnePlusECaller();
        return $caller->call($request);
    }

    public function getLastCampaignStatus()
    {
        $request = new \App\Services\OnePlusE\Requests\External\GetLastCampaignStatusRequest();
        $caller = new OnePlusECaller();
        return $caller->call($request);
    }
