...
class CreateShortDomainRequest extends AbstractRequest
{
    protected $path = '/admin_api/v1/domains';
     ...
     */
    public function __construct($name, $default_campaign_id = null, $group_id = null, $catch_not_found = null, $notes = null, $ssl_redirect = null, $allow_indexing = null, $admin_dashboard = null)
    {
        $this->name = $name;
